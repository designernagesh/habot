    ...
    <>
      <nav className="bg-white fixed w-full z-20 top-0 start-0">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="https://habot.io/" className="flex items-center space-x-3 rtl:space-x-reverse">
          ...
          <div className={`${active && 'hidden'} items-center grow justify-end md:mr-7 w-full md:flex md:w-auto md:order-1 p-6 md:p-0`} id="navbar-sticky">
